...
- 🤏 **Жест щипка** внутрь закрывает Launchpad (как в оригинале)
...
Добавьте `Launchpad.app` в «Системные настройки → Основные → Объекты входа».
...
- [ ] Перетаскивание между страницами и удаление приложений из папок жестами
- [ ] Иконка приложения (`AppIcon.icns`)
- [ ] Настройки: размер сетки, число колонок/строк, выбор горячей клавиши
